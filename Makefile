...
APP_SRCS = $(SRC_DIR)/main.c $(SRC_DIR)/mosh.c $(SRC_DIR)/executor.c $(SRC_DIR)/parser.c $(SRC_DIR)/utils.c
APP_OBJS = $(addprefix $(BUILD_DIR)/,$(notdir $(APP_SRCS:.c=.o)))
APP_EXEC = $(BUILD_DIR)/main

TEST_SRCS = $(TEST_DIR)/main_test.c $(SRC_DIR)/mosh.c $(SRC_DIR)/executor.c $(SRC_DIR)/parser.c $(SRC_DIR)/utils.c
